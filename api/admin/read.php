    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div class="smrt">
                ...
                <div class="row fling">
                    <h3><br> Liste des Utilisateurs</h3>
                </div>
                <br>

                
        <div class="xan">
        <?php if(isset($_GET['SucD']) && $_GET['SucD'] == "AcaCt"){
    echo "<span style='color:green;padding:1rem;'>L'activation d'un utilisateur a été bien effectué.</span> ";
} ?>
...
if($num>0){
  ...
  <?php 
                            ...
                            if($_SESSION['_Gtx'] == $id){ 
                      echo " <a href='../../view/moadmin.php?id=$id' class=' dropdown-item' style='color:#E1B72A;'
                      >Modifier</a> ";
                            }elseif(!isset($_SESSION["_AdMs"]) ){
                                echo "<button  type='button' class='btn pds' >
                                <img style='width:16px;height:auto;color:white;'  src='../../images/don.svg' /></button>";
                                    }else{echo  "<a href='../../view/moadmin.php?id=$id' class=' dropdown-item' style='color:#E1B72A;'
                                        >Modifier</a> 
                                       
                                         <button  onclick='del($id)' class='dropdown-item btn ' style='color:red;'>Supprimer</button>";} ?>
