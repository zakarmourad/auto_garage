    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div class="smrt">
                ...
                <div class="row ping">
                    <div class="col-9">
                        <h3> &nbsp;Liste des Voitures  &nbsp;<span><a href="../pdf/voitures.php" class='btn pds'   style="font-size:17px;color:white;background-color: #E1B72A;">
                ...
                <div class="row fling">
                    <h3><br> Liste des Voitures</h3> 
                </div>
                <br>

                <div class="xan">

                <?php if(isset($_GET['success']) && $_GET['success'] == 'VotDon' )  { echo "<span style='color:green;'>La voiture a bien été enregistrée.</span>";} ?>
                    ...
                    <table class=" gfg bg-light">
                        <thead>
                            <tr>
                                ...
                                <th>Model</th>
                                <th>Date</th>
                                <th class="kola">Modifier/Historique/Supprimer</th>
                            </tr>
                        </thead>
...
$num_start = ($page-1)*6;
$stmt = $voiture->pagination($num_start);
$num = $stmt->rowCount();
...
var cnkea = getUrlParameter('XzkdltvdAMwcxByCbe');
if(cnkea == null){
    //
}else{
    window.open('../pdf/demandeClient.php?id='+cnkea, '_blank');
