...
$client->id = isset($_GET['id']) ? trim($_GET['id']) : die();
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div class="smrt">
                ...
                <div class="row fling">
                    <h3><br> Modifier Un Client</h3>
                </div>
                <br>

                <div class="xan">
<?php if(isset($_GET['err']) && $_GET['err'] == 'CFNW' )  { echo "<span style='color:red;'>Erreur lors la modification du client.</span>";} ?>
<?php if(isset($_GET['err']) && $_GET['err'] == 'EmDHs' )  { echo "<span style='color:red;'>Veuillez remplir tous les champs nécessaires.</span>";} ?>
<?php if(isset($_GET['err']) && $_GET['err'] == 'CnMeAxSt' )  { echo "<span style='color:red;'>Ce nom du client existe déja dans cette base de données, les noms des clients sont uniques.</span>";} ?>
                    ...
                    <input type="hidden" name="hidId" value="<?php if(isset($_GET['id'])){ echo $_GET['id'];} ?>"/>
                        ...
                        <div class="row">
                            <div class="col"><label>Nom Complet (Non Modfifiable)</label></div>
                            <div class="col"><input type="text" class="pord" name="name" disabled placeholder="Nom Complet" value="<?php echo $client->name; ?>" required></div>

                        </div>
                        <div class="row">
                            <div class="col"><label>Adresse Email</label></div>
                            <div class="col"><input type="email" class="pord" name="contact" value="<?php echo $client->contact; ?>" placeholder="Contact" required></div>

                        </div>

                        <div class="row">
                            <div class="col"><label>Num Téléphone</label></div>
                            <div class="col"><input type="text" class="pord" name="tel" value="<?php echo $client->tel; ?>" placeholder="Téléphone" required></div>
                        ...
                        <div class="row">
                            ...
                            <div class="col"><select name="etat">
                                    <option <?php if($client->etat == "Encomp"){ echo "selected"; } ?> value="Encomp">Encomp</option>
                                    <option  <?php if($client->etat == "Comp"){ echo "selected"; } ?> value="Comp">Comp</option>
                                </select></div>

                        </div>
                        <div class="row">
                            <div class="col"></div>
                            <div class="col pol"><input type="submit" class="btn btn-block btn-outline-primary" value="Modifier"></div>
                        </div>
