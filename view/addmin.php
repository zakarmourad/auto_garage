...
<?php if(isset($_GET['sDXl']) && $_GET['sDXl'] == "AdAxISt"){
    echo "<span style='color:red;'>Erreur , le nom d'utilisateur doit être unique.</span>";
                    ...
                    <form action="../api/admin/postedcre.php" method="post">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="email" class="pord form-control" name="em" placeholder="Email" required>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="pord form-control" name="tel" placeholder="Téléphone" required>
                            </div>
                            <div class="form-group col-md-6">
                        ...
                        <div class="form-row">
                            <div class=" col-md-12">
                                <input type="submit"
                                    ...
                                    class="btn  btn-outline-primary" value="Ajouter"></div>
                        </div>
